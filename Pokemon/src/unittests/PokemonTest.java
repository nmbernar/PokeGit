...
public class PokemonTest {
	...
	public void testPokemon() {
		try {
			Pokemon pika = dbc.getPokemonFromName("Pikachu","N","N");
	...
	public void testNotAPokemon() {
		...
		try {
			simpson = dbc.getPokemonFromName("Simpson","N","N");
	...
	public void testGetName() {
		try {
			Pokemon tyrant = dbc.getPokemonFromName("Tyranitar","N","N");
	...
	public void testGetDexNumber() {
		try {
			Pokemon mew = dbc.getPokemonFromName("mewtwo","N","Y");
	...
	public void testGetPrimaryType() {
		try {
			Pokemon fly = dbc.getPokemonFromName("Flygon","N","N");
	...
	public void testGetSecondaryType() {
		try {
			Pokemon murk = dbc.getPokemonFromName("murkrow","N","N");
	...
	public void testGetTotal() {
		try {
			Pokemon goo = dbc.getPokemonFromName("Goodra","N","N");
	...
	public void testGetHp() {
		try {
			Pokemon oct = dbc.getPokemonFromName("Octillery","N","N");
	...
	public void testGetAtt() {
		try {
			Pokemon nite = dbc.getPokemonFromName("Dragonite","N","N");
	...
	public void testGetDef() {
		try {
			Pokemon golem = dbc.getPokemonFromName("Golem","N","N");
	...
	public void testGetSpatt() {
		try {
			Pokemon chand = dbc.getPokemonFromName("Chandelure","N","N");
	...
	public void testGetSpdef() {
		try {
			Pokemon del = dbc.getPokemonFromName("Delphox","N","N");
	...
	public void testGetSpd() {
		try {
			Pokemon ferro = dbc.getPokemonFromName("Ferrothorn","N","N");
